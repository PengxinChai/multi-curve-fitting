...
def print_help_message():
    ...
    print("The resampled file has two additional columns: rlnAnglePsi and rlnParticleSelectZScore;  rlnAnglePsi is the angle between tangent and X axis, rlnParticleSelectZScore is the curve number.")
