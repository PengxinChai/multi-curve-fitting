...
def resample(poly, polyk, left, right, mode, sample_step, cluster):
    ...
    if mode == 1:  # y=f(x) k = f(x)
        ...
        anglek = -math.degrees(math.atan(slopek))+90
        ...
        output_resam_Zscore.write(str(0.500000) + " ")
        output_resam_Zscore.write(str(count*ang_sample_step) + " ")
        ...
        output_resam_Zscore_txt.write(str(0.500000) + " ")
        output_resam_Zscore_txt.write(str(count*ang_sample_step) + " ")
        output_resam_Zscore_txt.write("0.500000 ")
        ...
        while current_y < right:
            ...
            if sample_step <= accumulation:
                ...
                output_resam_Zscore_txt.write(str(angle) + " ")
                output_resam_Zscore_txt.write(str(anglek) + " ")
                output_resam_Zscore_txt.write(str(0.5000000) + " ")
                output_resam_Zscore_txt.write(str(count*ang_sample_step) + " ")
                output_resam_Zscore_txt.write("0.500000 ")
                output_resam_Zscore_txt.write(str(cluster+1) + "\n")
...
for file_path in file_paths[:]:
    ...
    if ".star" in file_path:
        ...
        output_resam_Zscore.write(
            "\ndata_particles\n\nloop_\n_rlnCoordinateX #1\n_rlnCoordinateY #2\n_rlnCoordinateZ #3\n_rlnAnglePsiPrior #4\n_rlnAngleTiltPrior #5\n_rlnAngleRotFlipRatio #6\n_rlnHelicalTrackLengthAngst #7\n_rlnAnglePsiFlipRatio #8\n_rlnHelicalTubeID #9\n")
